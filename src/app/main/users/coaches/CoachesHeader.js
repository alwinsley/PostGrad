...
import { setCoachsSearchText } from '../store/coachsSlice';

function CoachesHeader(props) {
		...
		<div className="flex flex-1 w-full items-center justify-between">
					...
					<FuseAnimate animation="transition.slideDownIn" delay={300}>
						<Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8 shadow">
							...
							<Input
								...
								onChange={ev => dispatch(setCoachsSearchText(ev))}
							/>
						</Paper>
					</FuseAnimate>
				</ThemeProvider>
			...
			<FuseAnimate animation="transition.slideRightIn" delay={300}>
				...
				>
					...
					<span className="flex sm:hidden">Send</span>
				</Button>
			</FuseAnimate>
		</div>
	);
